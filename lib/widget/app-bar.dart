...
class CartButtons extends StatelessWidget {
  final VoidCallback? onTap;
  final Color? backgroundColor;
  const CartButtons({Key? key, this.onTap, this.backgroundColor}) : super(key: key);
    ...
    return InkWell(
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Icon(Icons.add_shopping_cart, size: 16.sp,),
        ),
      ),
    );
  }
...
class ThemeButtons extends StatelessWidget {
  ...
  final bool isDark;
  final Color? backgroundColor;
  const ThemeButtons({Key? key, this.onTap, this.backgroundColor, required this.isDark}) : super(key: key);
